...
+ (void)showSuccessWithStatus:(NSString *)string duration:(NSTimeInterval)duration {
    [self sharedView];
    [self showImage:SVProgressHUDSuccessImage status:string duration:duration maskType:SVProgressHUDDefaultMaskType];
}

// for duration
+ (void)showImage:(UIImage *)image status:(NSString *)string duration:(NSTimeInterval)duration {
    [self sharedView];
    [self showImage:image status:string duration:duration maskType:SVProgressHUDDefaultMaskType];
}
...
+ (void)showImage:(UIImage *)image status:(NSString *)string duration:(NSTimeInterval)duration maskType:(SVProgressHUDMaskType)maskType {
    [[self sharedView] showImage:image status:string duration:duration maskType:maskType];
}
